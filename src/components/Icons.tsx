...
const Icon = ({ size = 16, className = '', children }: IconProps & { children: React.ReactNode }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconHeart = ({ filled, ...props }: IconProps) => (
  <Icon {...props}>
    <path
...
export const IconStar = ({ filled, ...props }: IconProps) => (
  <Icon {...props}>
    <polygon
      fill={filled ? 'currentColor' : 'none'}
